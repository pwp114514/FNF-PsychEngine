...
class PlayState extends MusicBeatState
{
	...
	public var countdownE:FlxSprite;
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				{
					case 0:
						countdownE = new FlxSprite().loadGraphic(Paths.image(introAlts[0]));
						countdownE.cameras = [camHUD];
						countdownE.scrollFactor.set();
						countdownE.updateHitbox();

						if (PlayState.isPixelStage)
							countdownE.setGraphicSize(Std.int(countdownE.width * daPixelZoom));

						countdownE.screenCenter();
						countdownE.antialiasing = antialias;
						insert(members.indexOf(notes), countdownE);
						FlxTween.tween(countdownE, {/*y: countdownReady.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
