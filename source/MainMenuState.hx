...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.frames = Paths.getSparrowAtlas('menu/menu/buttons/' + optionShit[i]);
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Final Crossover v" + psychEngineVersion, 12);
